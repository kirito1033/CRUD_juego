...
<body>
    ...
    <div class="container">
        ...
        <!-- Container Table -->
        <?php require_once('../app/Views/warriortype/table.php'); ?>
        <!-- End Container Table -->
    </div>
    <!-- End Container -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form -->
                    <?php require_once('../app/Views/warriortype/form.php') ?>
                    <!-- End Form -->
                </div>
    ...
    <!-- JS Controller -->
    <script src="http://localhost/CRUD/crud/public/controllers/warriortype/warriortype.js"></script>
