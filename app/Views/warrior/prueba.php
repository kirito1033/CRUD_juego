<form id="my-form" method="POST" action="<?= base_url('warrior/store3') ?>" enctype="multipart/form-data">
    ...
    <label for="image">Imagen del Guerrero</label>
    </div>

    <button type="submit" class="btn btn-primary">Registrar Guerrero</button>
</form>