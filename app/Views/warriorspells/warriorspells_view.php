...
<body>
    ...
    <div class="container">
        ...
        <!-- Container Table -->
        <?php require_once('../app/Views/warriorspells/table.php'); ?>
        <!-- End Container Table -->
    </div>
    <!-- End Container -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form -->
                    <?php require_once('../app/Views/warriorspells/form.php') ?>
                    <!-- End Form -->
                </div>
    ...
    <!-- JS Controller -->
    <script src="http://localhost/CRUD/crud/public/controllers/warriorspells/warriorspells.js"></script>
